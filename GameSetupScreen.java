...
public final class GameSetupScreen extends JFrame implements ActionListener {
    ...
    //statics
    public static int TXT_COL = 10;
    public static int TXT_ROW = 1;
    public static int PANEL_COL = 2;
    public static int PANEL_ROW = 1;
    public static int GRID_COL = 1;
    public static int GRID_ROW = 6;


    public GameSetupScreen() {
        submitButton = new JButton("Submit");
        numRowsLbl = new JLabel("Number of Rows: ");
        numRowsTxt = new JTextArea(TXT_ROW, TXT_COL);
        numColsLbl = new JLabel("Number of Columns: ");
        numColsTxt = new JTextArea(TXT_ROW, TXT_COL);
        ...
        numWinTxt = new JTextArea(TXT_ROW, TXT_COL);
        ...
        this.setLayout(new GridLayout(GRID_ROW, GRID_COL));
        this.add(errorMessageLbl);
        JPanel rowsPanel = new JPanel(new GridLayout(PANEL_ROW, PANEL_COL));
        rowsPanel.add(numRowsLbl);
        rowsPanel.add(numRowsTxt);
        this.add(rowsPanel);

        JPanel colsPanel = new JPanel(new GridLayout(PANEL_ROW, PANEL_COL));
        colsPanel.add(numColsLbl);
        colsPanel.add(numColsTxt);
        this.add(colsPanel);

        JPanel winPanel = new JPanel(new GridLayout(PANEL_ROW, PANEL_COL));
        winPanel.add(numWinLbl);
        winPanel.add(numWinTxt);
        this.add(winPanel);

        JPanel playersPanel = new JPanel(new GridLayout(PANEL_ROW, PANEL_COL));
